...
class demo01Request {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type demo01Request
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type demo01Request
    let len;
    let data = new demo01Request(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new demo01Request(null);
...
class demo01Response {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type demo01Response
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type demo01Response
    let len;
    let data = new demo01Response(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new demo01Response(null);
...
module.exports = {
  Request: demo01Request,
  Response: demo01Response,
  md5sum() { return '4781436a0c2affec8025955a6041e481'; },
  datatype() { return 'plumbing_srv/demo01'; }
};
