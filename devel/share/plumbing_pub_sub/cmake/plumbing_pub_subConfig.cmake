...
if("TRUE" STREQUAL "TRUE")
  set(plumbing_pub_sub_SOURCE_PREFIX /home/ljm/demo_ws/src/plumbing_pub_sub)
  set(plumbing_pub_sub_DEVEL_PREFIX /home/ljm/demo_ws/devel)
  ...
  set(plumbing_pub_sub_INSTALL_PREFIX /home/ljm/demo_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'plumbing_pub_sub' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ljm/demo_ws/src/plumbing_pub_sub/${idir}'.  ${_report}")
    endif()
